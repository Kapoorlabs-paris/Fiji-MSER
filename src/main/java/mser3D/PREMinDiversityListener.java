...
public class PREMinDiversityListener implements AdjustmentListener {
	...
	public void adjustmentValueChanged(final AdjustmentEvent event) {
		CovistoMserPanel.minDiversity = ETrackScrollbarUtils.computeValueFromScrollbarPosition(event.getValue(), min, max, scrollbarSize);

		
			scrollbar.setValue(ETrackScrollbarUtils.computeScrollbarPositionFromValue(CovistoMserPanel.minDiversity, min, max, scrollbarSize));
