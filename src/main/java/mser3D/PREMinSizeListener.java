...
public class PREMinSizeListener implements AdjustmentListener {
	...
	public void adjustmentValueChanged(final AdjustmentEvent event) {
		CovistoMserPanel.minSize = (long) ETrackScrollbarUtils.computeValueFromScrollbarPosition(event.getValue(), min, max, scrollbarSize);

		
			scrollbar.setValue(ETrackScrollbarUtils.computeScrollbarPositionFromValue(CovistoMserPanel.minSize, min, max, scrollbarSize));
