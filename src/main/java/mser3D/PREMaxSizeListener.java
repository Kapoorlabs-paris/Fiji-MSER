...
public class PREMaxSizeListener implements AdjustmentListener {
	...
	public void adjustmentValueChanged(final AdjustmentEvent event) {
		CovistoMserPanel.maxSize = (long) ETrackScrollbarUtils.computeValueFromScrollbarPosition(event.getValue(), min, max, scrollbarSize);

		
			scrollbar.setValue(ETrackScrollbarUtils.computeScrollbarPositionFromValue(CovistoMserPanel.maxSize, min, max, scrollbarSize));
