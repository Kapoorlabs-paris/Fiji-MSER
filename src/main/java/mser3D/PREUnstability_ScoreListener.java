...
public class PREUnstability_ScoreListener implements AdjustmentListener {
	...
	public void adjustmentValueChanged(final AdjustmentEvent event) {
		    CovistoMserPanel.Unstability_Score = ETrackScrollbarUtils.computeValueFromScrollbarPosition(event.getValue(), min, max, scrollbarSize);

		
			scrollbar.setValue(ETrackScrollbarUtils.computeScrollbarPositionFromValue(CovistoMserPanel.Unstability_Score, min, max, scrollbarSize));
